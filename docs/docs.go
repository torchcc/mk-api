...
var doc = `{
        ...
        "/cancel_order/": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "取消订单的请求体",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CancelOrderInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/refund_order/": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "对订单申请退款的请求体",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.RefundOrderInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.CancelOrderInput": {
            ...
            "properties": {
                "cancel_reason_id": {
                    "description": "取消原因id, 1-支付时出故障，支付不了， 2-付款时 余额限制了 3-买多了/不想买了 4-信息写错，重新下单 5-朋友/网上评价不好 6-计划有变，时间按排不上，7-其他",
                    "type": "integer"
                },
                "order_id": {
                    "type": "integer"
        ...
        "dto.RefundOrderInput": {
            ...
            "properties": {
                ...
                "refund_reason_id": {
                    "description": "退款原因id 3-买多了/不想买了 4-信息写错，重新下单 5-朋友/网上评价不好 6-计划有变，时间按排不上，7-其他",
                    "type": "integer"
                },
                "refund_reason_remark": {
                    "description": "退款具体原因描述",
                    "type": "string"
                }
            }
        },
